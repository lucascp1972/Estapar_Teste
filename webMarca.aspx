<%@ Page Language="C#" Title="Marca" AutoEventWireup="true" CodeBehind="webMarca.aspx.cs" Inherits="estapar.webMarca" %>
        ...
        <table style="width: 100%; background-color: #DFDFDF;">
            ...
            <table style=" width: 100%; margin-bottom: 5px; margin-top: 5px;" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <asp:Label ID="Label7" runat="server" Font-Names="Arial Black" Font-Size="Medium" ForeColor="White" Text="Marca do Carro" Font-Bold="False"></asp:Label>
                    </td>
                </tr>
            </table>
            <table style="width:100%; background-color: #e4e4e4;">
                <tr>
                        ...
                        <table style="width:100%;">
                            ...
                            <tr>
                                ...
                                <td style="width: 1500px; height: 30px; vertical-align: middle; text-align: left; " class="styTextLabel">
                                    <asp:TextBox ID="cma_id" runat="server" AutoComplete="off" CssClass="styTextBox"></asp:TextBox>
                                </td>
                            ...
                            <tr>
                                <td style="width: 600px; height: 40px; vertical-align: middle; text-align: right; padding-right: 15px">
                                <asp:Label ID="Label10" runat="server" Font-Names="Calibri" Font-Size="Medium" ForeColor="#333333" Text="MARCA : "></asp:Label>
                                </td>
                                <td style="width: 1500px; height: 30px; vertical-align: middle; text-align: left; " class="styTextLabel">
                                    <asp:TextBox ID="cma_marca" runat="server" AutoComplete="off" CssClass="styTextBox"></asp:TextBox>
                                </td>
                    ...
                    <asp:Label ID="Label14" runat="server" Font-Names="Calibri" Font-Size="Medium" ForeColor="#333333" Text="MARCA : "></asp:Label>
                                </td>
                    ...
                    <asp:ImageButton ID="imgSelect" runat="server" ImageUrl="~/Images/seta_e.png" Width="18px" OnClick="imgSelect_Click" Height="20px" />
                                ...
                                <td class="styTextLabel">
                                    <asp:ListBox ID="lstMarca" runat="server" CssClass="styTextBox" Height="200px" OnSelectedIndexChanged="lstMarca_SelectedIndexChanged">
